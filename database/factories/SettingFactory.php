...
class SettingFactory extends Factory
{
    ...
    {
        return [
            'email' => 'chaounihamza19@gmail.com',
            'logo' => 'example_logo.png',
            'favicon' => 'example_favicon.ico',
            'address_one' => '73, Rue jbel hebri Hay nacer',
            'address_two' => 'Kom- Rabat/Salé',
            'city' => 'Rabat',
            'province' => 'Ahsaine',
            'postal_code' => '11000',
            'country' => 'Maroc',
            'time_zone' => $this->faker->timezone(),
            'date_format' => $this->faker->date($format = 'Y-m-d', $max = 'now'),
            'time_format' => $this->faker->time($format = 'H:i:s', $max = 'now'),
            'currency' => 'USD',
